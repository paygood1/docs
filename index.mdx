...
<CardGroup cols={2}>
  ...
  <Card title="Merchant Onboarding" icon="building" href="/guides/merchant-onboarding-overview">
    Guide your merchants through the KYB application and approval process.
  </Card>
</CardGroup>
