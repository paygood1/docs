...
You can identify which type of key you are using by the PayGood dashboard environment. Always use a sandbox key in your development and staging environments, and reserve your live key strictly for production traffic.
